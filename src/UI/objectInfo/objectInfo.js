...
function addCollisionsButtonHandler(){
    let addFlagBut = document.getElementById('mainInfoBox-body-collisions-add');
    let text = document.getElementById('mainInfoBox-body-collisions-text');
    let close = document.getElementById('mainInfoBox-body-collisions-close');
    let accept = document.getElementById('mainInfoBox-body-collisions-add2');
    close.style.display = 'block';
    addFlagBut.style.display = 'none';
    accept.style.display = 'block';
...
function createCollisionsView(cols){
    let collsInfo = document.getElementById('mainInfoBox-body-collisions-main');
    collsInfo.innerHTML = "";
    let obj = bb.fastGet('state', 'focusedObject');
...
function fillObjectActions(obj){
    ...
    if(Engine.hasManager('SnapshotManager')){
        ...
        let snapBut = document.getElementById('mainInfoBox-options-snapshot');
        snapBut.onclick = ()=>{
...
function updateInfo(obj){
    ...
    let nameBox = document.getElementById('mainInfoBox-head-name');
    ...
    if(!Engine.ObjectManager.isSystemObject(obj.id)){
        ...
        let changeNameBut = document.getElementById('mainInfoBox-body-name-edit');
    ...
    let addCollBut = document.getElementById('mainInfoBox-body-collisions-add');
